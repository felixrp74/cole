    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <label for="genero_apoderado" class="col-sm-4 col-form-label">genero_apoderado</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="nombre_apoderado" class="col-sm-4 col-form-label">nombre_apoderado</label>
                    <div class="col-sm-10">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <label for="dni_apoderado" class="col-sm-4 col-form-label">dni_apoderado</label>
                    <div class="col-sm-10">
        ...
        @if($vive == 'SI') 
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <label for="email_apoderado" class="col-sm-4 col-form-label">email_apoderado</label>
                        <div class="col-sm-10">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <label for="celular_apoderado" class="col-sm-4 col-form-label">celular_apoderado</label>
                        <div class="col-sm-10">
